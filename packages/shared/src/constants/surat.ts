...
export interface JenisSurat {
   ...
   *
   * "keperluan" TIDAK boleh dicantumkan di sini: ia sudah menjadi kolom
   * tersendiri pada formulir dan pada ajukanSuratSchema. Mencantumkannya lagi
   * membuat warga melihat dua kotak Keperluan sekaligus.
   */
...
export const JENIS_SURAT: JenisSurat[] = [
  { kode: 'DOMISILI', nama: 'Surat Domisili', fieldTambahan: ['alamat_domisili', 'lama_tinggal'], lampiran: ['KTP', 'KK'] },
  ...
  { kode: 'TIDAK_MAMPU', nama: 'Surat Tidak Mampu', fieldTambahan: ['penghasilan_perbulan'], lampiran: ['KTP', 'KK'] },
  ...
  { kode: 'BELUM_MENIKAH', nama: 'Surat Keterangan Belum Menikah', fieldTambahan: [], lampiran: ['KTP', 'KK'] },
  { kode: 'PENGHASILAN', nama: 'Surat Keterangan Penghasilan', fieldTambahan: ['pekerjaan', 'penghasilan_perbulan'], lampiran: ['KTP', 'KK'] },
  { kode: 'SKCK', nama: 'Surat Pengantar SKCK', fieldTambahan: [], lampiran: ['KTP', 'KK'] },
